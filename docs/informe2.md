...
En esta segunda parte del obligatorio, aprendí mucho en varios aspectos. Por un lado, adquirí conocimientos sobre herramientas como ESLint y Prettier, que nos ayudaron a mantener el código limpio y estandarizado, pruebas unitarias que fueron clave para garantizar la calidad de nuestra aplicación.
