...
1.  **Título:** Verificar el Plan de Clase
...
2.  **Título:** Crear un Plan de Clase
...
3.  **Título:** Recibir Notificaciones de Cambios
...
5.  **Título:** Ver Información de Alumnos
...
3.  **Título:** Editar un Plan de Clase
...
5.  **Título:** Cerrar Sesión en la Aplicación
